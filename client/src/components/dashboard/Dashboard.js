			...
			if (Object.keys(profile).length > 0) {
				...
				dashboardContent = (
					<div>
						...
						<p>Employee have not yet setup a profile. please contact Employee to update profile</p>

						<Link to="/login" className="btn btn-lg btn-info" onClick={this.onLogoutClick.bind(this)}>
							Logout
						</Link>
					</div>
				);
